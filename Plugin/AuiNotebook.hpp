#ifndef AUINOTEBOOK_HPP
#define AUINOTEBOOK_HPP
...
class clAuiNotebook : public wxAuiNotebook
{
protected:
...
protected:
    ...
    void OnPageClose(wxBookCtrlEvent& e);
    void OnPageClosed(wxBookCtrlEvent& e);
    void OnTabRightDown(wxBookCtrlEvent& e);
    void OnTabMiddleDown(wxBookCtrlEvent& e);
    void OnListButtonDown(wxBookCtrlEvent& e);
...
public:
    clAuiNotebook(wxWindow* parent, wxWindowID id, const wxPoint& pos = wxDefaultPosition,
    ...
    bool LoadPerspective(wxString& perspective, bool update = true);
};
